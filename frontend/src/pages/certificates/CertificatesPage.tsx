...
const CertificatesPage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Earned Certificates */}
            <div>
                <h2 className="text-xl font-semibold mb-4">Earned Certificates ({certificates.length})</h2>
                <div className="grid gap-6 md:grid-cols-2">
                    {certificates.map((cert) => (
                        <Card key={cert.id} className="overflow-hidden">
                            ...
                            <CardHeader>
                                <CardTitle className="line-clamp-1">{cert.title}</CardTitle>
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Complete module and score {module.requiredScore}% to earn certificate
                                        </p>
                                    </div>
